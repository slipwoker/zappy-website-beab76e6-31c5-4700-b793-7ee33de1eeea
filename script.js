    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Triple a uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: 'beab76e6-31c5-4700-b793-7ee33de1eeea',
                        name: data.name,
                        email: data.email,
